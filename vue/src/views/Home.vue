      ...
      <el-dialog v-model="dialogVisible" title="Tips" width="30%">
        <el-form :model="form" label-width="120px">
          <el-form-item label="用户名">
            <el-input v-model="form.username" sytle="width: 80%"></el-input>
          </el-form-item>
          <el-form-item label="昵称">
            <el-input v-model="form.nickName" sytle="width: 80%"></el-input>
          </el-form-item>
          <el-form-item label="年龄">
            <el-input v-model="form.age" sytle="width: 80%"></el-input>
          </el-form-item>
          ...
          <el-form-item label="地址">
            <el-input type="textarea" v-model="form.address" sytle="width: 80%"></el-input>
          </el-form-item>
        </el-form>
        <template #footer>
